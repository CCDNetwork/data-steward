...
namespace Ccd.Server.Migrations
{
    ...
    [Migration("20240523122532_AddReferralsFields")]
    partial class AddReferralsFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ccd.Server.Referrals.Referral", b =>
                {
                    ...
                    b.HasIndex("FileId")
                        .HasDatabaseName("ix_referral_file_id");
            ...
            modelBuilder.Entity("Ccd.Server.Referrals.Referral", b =>
                {
                    b.HasOne("Ccd.Server.Storage.File", "File")
                        ...
                        .HasConstraintName("fk_referral_file_file_id");
