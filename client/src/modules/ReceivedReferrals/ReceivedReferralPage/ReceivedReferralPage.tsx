  ...
  const receivingReferral = useMemo(
    () => ({
      ...
      dateOfBirth: receivedReferralData?.dateOfBirth
        ? formatDate(receivedReferralData.dateOfBirth, 'MM/dd/yyyy')
        : 'N/A',
          ...
          <CardContent>
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="sm:col-span-1">
                ...
                <dd className="mt-1 text-sm leading-6 sm:mt-2">{receivingReferral.gender}</dd>
              </div>
              <div className="sm:col-span-1">
              ...
              <div className="sm:col-span-2">
                ...
                <dd className="mt-1 text-sm leading sm:mt-2 capitalize">{receivingReferral.restrictions}</dd>
              </div>
            </dl>
          </CardContent>
              ...
              <CardContent>
                <dl className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <dd className="mt-1 text-sm leading sm:mt-2 capitalize">{receivingReferral.caregiver}</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium leading-6">Relationship to child</dt>
                    <dd className="mt-1 text-sm leading sm:mt-2 capitalize">{receivingReferral.relationshipToChild}</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium leading-6">Caregiver email</dt>
                    <dd className="mt-1 text-sm leading sm:mt-2 capitalize">{receivingReferral.caregiverEmail}</dd>
                  </div>
                  <div className="sm:col-span-1">
          ...
          <CardContent>
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="sm:col-span-2">
                ...
                <dd className="mt-1 text-sm leading sm:mt-2 capitalize">{receivingReferral.required}</dd>
              </div>
              <div className="sm:col-span-2">
                <dt className="text-sm font-medium leading-6">Service explanation</dt>
                <dd className="mt-1 text-sm leading sm:mt-2 capitalize">{receivingReferral.needForService}</dd>
              </div>
              <div className="sm:col-span-2">
