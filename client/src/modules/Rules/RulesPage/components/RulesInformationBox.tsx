  ...
  return (
    <Alert className="w-auto mt-4">
      ...
      <AlertDescription className="sm:text-sm text-xs">
        Rules are lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam quam recusandae eligendi delectus
        autem commodi neque similique iusto temporibus qui?
      </AlertDescription>
    </Alert>
  );
};
