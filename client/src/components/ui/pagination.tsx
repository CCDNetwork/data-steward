...
import { ChevronsRightIcon, LucideChevronsLeft } from 'lucide-react';
...
const PaginationPrevious = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
  <PaginationLink
    ...
    size="default"
    className={cn('gap-1 px-2 lg:px-4 lg:pl-2.5', className)}
    {...props}
  >
...
const PaginationNext = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => (
  <PaginationLink
    ...
    size="default"
    className={cn('gap-1 px-2 lg:px-4 lg:pr-2.5', className)}
    {...props}
  >
...
const PaginationFirstPage = ({ ...props }: React.ComponentProps<typeof PaginationLink>) => (
...
const PaginationLastPage = ({ ...props }: React.ComponentProps<typeof PaginationLink>) => (
